// shape5.cpp: Illustrates protected access
//
// Note: We make id protected so derived classes don't
// have to call getID. But we also make the id field
// const so derived classes can't change it. Data members
// that are const MUST be in the constructor's initializer
// list!
// 
// See the change in the to_string functions.
